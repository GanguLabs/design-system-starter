...
StyleDictionary.registerFormat({
	...
	format: ({ dictionary, platform, options, file }) => {
		// 1. Metadata & Documentation Header
		const header = `/**
			* GENERATED DESIGN TOKENS - DO NOT EDIT
			* ---------------------------------------
			* This file was generated by Style Dictionary.
			* * WHY THIS FORMAT?
			* - 'as const': Ensures literal type inference. Instead of 'string', 
			...
			* - 'Tokens' Type: Provides full hierarchical autocomplete.
			* - 'TokenPath' Type: A string-union of all valid token paths
		...
		// 5. Concatenate and return the final output
		return [header, tokensObject, types].join('\n');
	},
});
